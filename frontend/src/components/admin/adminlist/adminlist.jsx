...
export default function AdminList({ account }) {
                        ...
                        {admins.toSorted((a, b) => {
                            ...
                            return (
                                <tr key={i} data-id={i}>
                                    ...
                                    <td className="dateEdit center">{!item.dateEdit ? 'Не повышался' : moment(item.dateEdit).format('LLL')}</td>
